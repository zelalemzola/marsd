...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center h-[80vh] gap-5 relative z-20'>
      ...
      <div className="absolute -z-20 top-40 w-full hidden md:flex items-center justify-between pl-6">
        <Image src='/marsh4.png' alt='hero1' width={300} height={300}/>
        <Image src='/marsh.png' alt='hero1' width={400} height={400} className=' -mt-[20%]'/>
      </div>
